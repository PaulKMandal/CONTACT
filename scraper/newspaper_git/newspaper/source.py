...
class Source(object):
    ...
    def purge_articles(self, reason, articles):
        ...
        return articles
    #CHANGE SECONDS TO DETERMINE WHEN CACHE IS RESET
    @utils.cache_disk(seconds=(1 * 1), cache_folder=ANCHOR_DIRECTORY)
    ...
    def _generate_articles(self):
        ...
        #    print("category_articles",article.url)
        feed_articles = self.feeds_to_articles()
        #for article in feed_articles:
        #    print(feed_articles,article.url)
